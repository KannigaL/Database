public class TestPortal {
   ...
   public static void main(String[] args) {
      try{
          ...
          // 6. Unregister a student from a restricted course that he/she is registered to, and which has at least two students in the queue.
          // Register again to the same course and check that the student gets the correct (last) position in the waiting list.
          ...
          // 8. Unregister a student from an overfull course, i.e. one with more students registered
          // than there are places on the course (you need to set this situation up in the database directly).
          ...
          System.out.println(c.unregisterBad("1111111111", "CCC111' OR 'a'='a"));
          pause();
